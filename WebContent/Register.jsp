						...
						<div class="center">
							<h1>
								<i class="icon-leaf green"></i> <span class="red"></span> <span
									class="white">请输入用户名、密码和邮箱</span>
							</h1>
							<h4 class="blue">&copy; L</h4>
						</div>
											...
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														...
														placeholder="手机号码" /> <i class="icon-user"></i>
												</span>
													...
													class="block input-icon input-icon-right"> <input
														...
														placeholder="邮箱" /> <i class="icon-lock"></i>
												</span>
												</label>
												...
												<div class="clearfix">
													<label class="inline"> <input type="checkbox"
														style="display: none" /> <span class="lbl"> </span>
													</label>

													<button type="button"
														class="width-35 pull-right btn btn-sm btn-primary loginBtn">
